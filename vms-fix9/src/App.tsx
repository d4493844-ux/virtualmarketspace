        ...
        <ThemeProvider>
          <AuthProvider>
            ...
            <Routes>
              ...
              <Route path="/rider/apply" element={<PrivateRoute><RiderApplyPage /></PrivateRoute>} />
              <Route path="/rider/deliveries" element={<PrivateRoute><AvailableDeliveriesPage /></PrivateRoute>} />
              <Route path="/delivery/request/:orderId" element={<PrivateRoute><DeliveryRequestPage /></PrivateRoute>} />
