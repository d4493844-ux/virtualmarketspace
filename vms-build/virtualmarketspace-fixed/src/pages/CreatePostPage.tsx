      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-6">
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <button type="button" onClick={() => setPostType('text')} className="p-4 rounded-xl flex flex-col items-center gap-2"
              style={{ backgroundColor: postType === 'text' ? '#3b82f6' : 'var(--bg-secondary)', color: postType === 'text' ? 'white' : 'var(--text-primary)' }}>
